...
namespace CapaNegocio{
    public class NAsignarMasivo{
        ...
        public static DataTable EnviarCartera(string gestor, string codigo, int id_seguimiento, int id_estado, decimal monto){
            DAsignarMasivo Datos = new DAsignarMasivo();
            return Datos.EnviarCartera(gestor,codigo,id_seguimiento, id_estado, monto);
        }
