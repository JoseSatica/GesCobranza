...
namespace CapaPresentacion{
    public partial class FrmCarteraGestionDetalle : Form{
        ...
        private void limpiar(){
            TxtNomPersNoti.Text = "";TxtDniPersNoti.Text = "";TxtEdadPersNoti.Text = "";TxtParentPersNoti.Text = "";
            TxtObserNoti.Text = "";CbxSeguimiento.Text = "";EpObservacion.Clear();EpSeguimiento.Clear();
